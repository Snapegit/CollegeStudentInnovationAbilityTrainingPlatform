	...
	<div>
		<div class="app-contain">
			<div class="list_search_view">
				...
				<br>
				<div class="btn_view">
					<el-button type="success" @click="addClick" v-if="btnAuth('discussjiangzuoxinxi','新增')">新增</el-button>
					<el-button type="primary" :disabled="selRows.length==1?false:true" @click="editClick" v-if=" btnAuth('discussjiangzuoxinxi','修改')">修改</el-button>
			...
			<el-table
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="center">
					<template #default="scope">
						<el-button v-if="btnAuth('discussjiangzuoxinxi','查看评论')" type="warning" @click="commentClick(scope.row.id)">查看评论</el-button>
...
<script setup>
	...
	//基础信息
	const tableName = 'discussjiangzuoxinxi'
	const formName = '讲座信息评论表'
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscussjiangzuoxinxi?refid=' + id)
	}
