...
<template>
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				<el-col :span="8">
					<el-form-item label="比赛项目" prop="bisaixiangmu">
						<el-input class="list_inp" v-model="form.bisaixiangmu" placeholder="比赛项目"
							 type="text" 							:readonly="!isAdd||disabledForm.bisaixiangmu?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="参赛要求" prop="cansaiyaoqiu">
						<el-input class="list_inp" v-model="form.cansaiyaoqiu" placeholder="参赛要求"
							 type="text" 							:readonly="!isAdd||disabledForm.cansaiyaoqiu?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="结果" prop="jieguo">
						<el-input v-model="form.jieguo" placeholder="结果" type="textarea"
						:readonly="!isAdd||disabledForm.jieguo?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='bisaixiangmu'){
					form.value.bisaixiangmu = row[x];
					disabledForm.value.bisaixiangmu = true;
					continue;
				}
				if(x=='cansaiyaoqiu'){
					form.value.cansaiyaoqiu = row[x];
					disabledForm.value.cansaiyaoqiu = true;
					continue;
				}
				if(x=='fabushijian'){
				...
				if(x=='jieguo'){
					form.value.jieguo = row[x];
					disabledForm.value.jieguo = true;
					continue;
				}
			}
			if(row){
