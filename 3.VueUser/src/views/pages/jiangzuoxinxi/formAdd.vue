			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="讲座详情" prop="jiangzuoxiangqing">
						<editor class="list_editor" :value="form.jiangzuoxiangqing" placeholder="请输入讲座详情" :readonly="!isAdd||disabledForm.jiangzuoxiangqing?true:false"
							@change="(e)=>editorChange(e,'jiangzuoxiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.jiangzuoxiangqing = res.data.data.jiangzuoxiangqing.replace(reg,'../../../cl49116136/file');
