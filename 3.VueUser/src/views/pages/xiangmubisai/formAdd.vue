	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="12">
					<el-form-item label="项目申请书" prop="xiangmushenqingshu">
						<uploads
							:disabled="!isAdd||disabledForm.xiangmushenqingshu?true:false"
							type="file"
							action="file/upload" 
							tip="请上传项目申请书" 
							:limit="1" 
							style="width: 100%;text-align: left;"
							:fileUrls="form.xiangmushenqingshu?form.xiangmushenqingshu:''" 
							@change="xiangmushenqingshuUploadSuccess">
						</uploads>
					</el-form-item>
				</el-col>
				<el-col :span="8">
...
<script setup>
	...
	//项目申请书上传回调
	const xiangmushenqingshuUploadSuccess=(e)=>{
		form.value.xiangmushenqingshu = e
	}
	//methods
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.xiangmuxiangqing = res.data.data.xiangmuxiangqing.replace(reg,'../../../cl49116136/file');
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xiangmushenqingshu'){
					form.value.xiangmushenqingshu = row[x];
					disabledForm.value.xiangmushenqingshu = true;
					continue;
				}
				if(x=='yonghuzhanghao'){
	...
	//提交
	const save=()=>{
		if(form.value.xiangmushenqingshu!=null) {
			form.value.xiangmushenqingshu = form.value.xiangmushenqingshu.replace(new RegExp(context?.$config.url,"g"),"");
		}
