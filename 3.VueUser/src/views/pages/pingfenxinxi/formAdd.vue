	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"0px","background":"#fff","width":"86%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="评分要求" prop="pingfenyaoqiu">
						<el-input v-model="form.pingfenyaoqiu" placeholder="评分要求" type="textarea"
						:readonly="!isAdd||disabledForm.pingfenyaoqiu?true:false"
						/>
					</el-form-item>
				</el-col>
			</el-row>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='pingfenyaoqiu'){
					form.value.pingfenyaoqiu = row[x];
					disabledForm.value.pingfenyaoqiu = true;
					continue;
				}
				if(x=='fabushijian'){
