			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="反馈标题" prop="fankuibiaoti">
						<el-input class="list_inp" v-model="form.fankuibiaoti" placeholder="反馈标题"
							 type="text" 							:readonly="!isAdd||disabledForm.fankuibiaoti?true:false" />
					</el-form-item>
				</el-col>
				...
				<el-col :span="24">
					<el-form-item label="反馈内容" prop="fankuineirong">
						<editor class="list_editor" :value="form.fankuineirong" placeholder="请输入反馈内容" :readonly="!isAdd||disabledForm.fankuineirong?true:false"
							@change="(e)=>editorChange(e,'fankuineirong')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.fankuineirong = res.data.data.fankuineirong.replace(reg,'../../../cl49116136/file');
